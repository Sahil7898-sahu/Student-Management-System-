// Complete Error-Free Student Management System - Perfect Version
class PerfectStudentSystem {
    constructor() {
        this.students = [];
        this.deskCharge = 500;
    ...
    displayRecentStudents() {
        try {
            ...
            container.innerHTML = recent.map(student => `
                <div class="recent-student" onclick="perfectSystem.showStudentDetails('${student.id}')">
    ...
    displayStudentsTable() {
        try {
            ...
            // Sort students by desk number - FIXED REGEX
            ...
            const tableHTML = `
                <div class="table-header">
                    ...
                    <div class="table-actions">
                        <button class="btn-primary" onclick="perfectSystem.displayStudentsTable()">
                            ...
                            ${sortedStudents.map(student => {
                                ...
                                return `
                                    <tr>
                                        ...
                                        <td>
                                            <button class="student-name-btn" onclick="perfectSystem.showStudentDetails('${student.id}')">
                                        ...
                                        <td>
                                            <button class="btn-primary btn-sm" onclick="perfectSystem.showStudentDetails('${student.id}')">
                                                <i class="fas fa-eye"></i> View
                                            </button>
                                            <button class="btn-danger btn-sm" onclick="perfectSystem.showRemoveStudentModal('${student.id}')">
                        ...
                        <div class="student-detail-grid">
                            ...
                            <div class="detail-section">
                                <div class="action-buttons">
                                    <button class="btn-primary" onclick="perfectSystem.showAdminPaymentModal('${student.id}')">
                                        <i class="fas fa-plus"></i> Add Payment
                                    </button>
                                    <button class="btn-danger" onclick="perfectSystem.showRemoveStudentModal('${student.id}')">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="warning-section">
                            ...
                            <div class="warning-content">
                                ...
                                <ul style="margin-left: 1.5rem; color: var(--text-secondary);">
                                    <li>Remove ${this.escapeHtml(student.name)} from the system</li>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="removal-notes" rows="3" placeholder="Enter any additional notes about the removal..."></textarea>
                        </div>

                        <div class="form-actions">
                            <button type="button" class="btn-danger" onclick="perfectSystem.confirmRemoveStudent('${studentId}')">
                                <i class="fas fa-user-times"></i> Remove Student
                            </button>
                            <button type="button" class="btn-secondary" onclick="this.closest('.modal').remove()">
    ...
    confirmRemoveStudent(studentId) {
        try {
            ...
            // Try to sync with Google Sheets
            if (this.isOnline) {
                this.makeRequest('removeStudent', { studentId, removalRecord })
                    .then(response => {
                        if (response.status === 'success') {
    ...
    exportToPDF() {
        try {
            ...
            // Sort students by desk number for PDF - FIXED REGEX
            const sortedStudents = [...this.students].sort((a, b) => {
                const aNum = parseInt(a.deskNumber.replace(/[^0-9]/g, '')) || 0;
                const bNum = parseInt(b.deskNumber.replace(/[^0-9]/g, '')) || 0;
                return aNum - bNum;
    ...
    exportToJSON() {
        try {
            ...
            a.href = url;
            a.download = `perfect-student-data-${new Date().toISOString().split('T')[0]}.json`;
            a.click();
...
document.addEventListener('DOMContentLoaded', function() {
    try {
        window.perfectSystem = new PerfectStudentSystem();
    } catch (error) {
